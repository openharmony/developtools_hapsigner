 ...
 */
#ifndef SIGNERTOOLS_BYTEBUFFER_H
#define SIGNERTOOLS_BYTEBUFFER_H
#include <memory>
#include <string>
...
namespace OHOS {
     ...
     */
        ...
        public:
            ...
            DLL_EXPORT int32_t Remaining() const; // return bytes between position and limit
            DLL_EXPORT bool HasRemaining() const; // indicates data available between position and limit
            DLL_EXPORT void Clear();              // return to the initial state
            DLL_EXPORT ByteBuffer& Flip();        // switch from write state to read state
