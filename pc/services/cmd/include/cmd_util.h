...
namespace OHOS {
    namespace SignatureTools {
        ...
        public:
            ...
            void StringComparisonAssignment(char** args, int first);
            bool GetKey(char** args, std::vector<std::string> &trustList, std::string& keyStandBy, int i);
            bool GetValue(char** args, ParamsSharedPtr param, std::string& keyStandBy, int i);
        private:
