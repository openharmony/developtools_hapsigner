...
bool ProfileVerifyUtils::ParseProfile(Pkcs7Context& profilePkcs7Context,
                                      ...
                                      const ByteBuffer& pkcs7ProfileBlock, std::string& profile)
{
    ...
    if (!VerifyHapOpensslUtils::ParsePkcs7Package(pkcs7Block, pkcs7Len, profilePkcs7Context)) {
...
bool ProfileVerifyUtils::VerifyProfile(Pkcs7Context& pkcs7Context)
{
