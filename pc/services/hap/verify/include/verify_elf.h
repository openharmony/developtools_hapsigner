 ...
 */
#ifndef SIGNERTOOLS_VERIFY_ELF_H
#define SIGNERTOOLS_VERIFY_ELF_H
...
namespace OHOS {
    namespace SignatureTools {
        ...
        public:
            ...
            static bool VerifyP7b(std::unordered_map<signed char, SigningBlock>& signBlockMap, Options* options,
