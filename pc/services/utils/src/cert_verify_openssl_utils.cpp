...
namespace OHOS {
    namespace SignatureTools {
        ...
        const uint32_t HapCertVerifyOpensslUtils::MIN_CERT_CHAIN_LEN_NEED_VERIFY_CRL = 2;
        const int32_t HapCertVerifyOpensslUtils::OPENSSL_READ_CRL_MAX_TIME = 1048576; // 1024 * 1024
        const int32_t HapCertVerifyOpensslUtils::OPENSSL_READ_CRL_LEN_EACH_TIME = 1024;
        const int32_t HapCertVerifyOpensslUtils::BASE64_ENCODE_LEN_OF_EACH_GROUP_DATA = 4;
        const int32_t HapCertVerifyOpensslUtils::BASE64_ENCODE_PACKET_LEN = 3;
        ...
        bool HapCertVerifyOpensslUtils::GetPublickeyBase64FromPemCert(const std::string& certStr,
        ...
        bool HapCertVerifyOpensslUtils::GetFingerprintBase64FromPemCert(const std::string& certStr,
        ...
        bool HapCertVerifyOpensslUtils::GetOrganizationFromPemCert(const std::string& certStr,
        ...
        */
        ...
        X509_CRL* HapCertVerifyOpensslUtils::GetX509CrlFromDerBuffer(const ByteBuffer& crlBuffer,
        ...
        bool HapCertVerifyOpensslUtils::VerifyCertChainPeriodOfValidity(CertChain& certsChain,
        ...
        bool HapCertVerifyOpensslUtils::VerifyCrl(CertChain& certsChain, STACK_OF(X509_CRL)* crls,
        ...
        void HapCertVerifyOpensslUtils::GetTextFromX509Name(X509_NAME* name, int32_t nId, std::string& text)
        {
