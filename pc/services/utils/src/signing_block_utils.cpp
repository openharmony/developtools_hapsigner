...
namespace OHOS {
    namespace SignatureTools {
        ...
        bool HapSigningBlockUtils::FindEocdInHap(RandomAccessFile& hapFile, std::pair<ByteBuffer, long long>& eocd)
        {
            /*
        ...
        */
        bool HapSigningBlockUtils::FindEocdInSearchBuffer(ByteBuffer& searchBuffer, int& offset)
        {
        ...
        bool HapSigningBlockUtils::GetCentralDirectoryOffset(ByteBuffer& eocd, long long eocdOffset,
        ...
        bool HapSigningBlockUtils::GetCentralDirectorySize(ByteBuffer& eocd, long& centralDirectorySize)
        {
            uint32_t cdSize;
        ...
        bool HapSigningBlockUtils::SetUnsignedInt32(ByteBuffer& buffer, int32_t offset, long long value)
        {
        ...
        bool HapSigningBlockUtils::ParseSignBlockHead(HapSignBlockHead& hapSignBlockHead, ByteBuffer& hapBlockHead)
        {
        ...
        bool HapSigningBlockUtils::ParseSubSignBlockHead(HapSubSignBlockHead& subSignBlockHead,
         ...
         */
        bool HapSigningBlockUtils::FindHapSubSigningBlock(RandomAccessFile& hapFile,
                                                          int32_t blockCount,
        ...
        bool HapSigningBlockUtils::GetOptionalBlockIndex(std::vector<OptionalBlock>& optionBlocks,
                                                         int32_t type,
                                                         int& index)
        {
        ...
        long long HapSigningBlockUtils::CreatTestZipFile(const std::string& pathFile, SignatureInfo& signInfo)
        {
        ...
        void HapSigningBlockUtils::CreateHapSubSignBlockHead(HapSubSignBlockHead& signBlob,
                                                             HapSubSignBlockHead& profileBlob,
                                                             HapSubSignBlockHead& propertyBlob)
        {
