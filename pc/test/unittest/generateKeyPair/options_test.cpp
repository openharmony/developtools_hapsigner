 ...
 * @tc.require:
 */
HWTEST_F(OptionsCmdTest, cmd_util_test_005, testing::ext::TestSize.Level1)
{
    ParamsTrustlist params_trust_list;
...
/*
* @tc.name: params_run_test_060
* @tc.desc: main function entry function.
* @tc.type: FUNC
* @tc.require:
*/
HWTEST_F(OptionsCmdTest, params_run_test_060, testing::ext::TestSize.Level1)
{
    std::string str = "abcd";
...
/*
* @tc.name: params_run_test_102
* @tc.desc: main function entry function.
* @tc.type: FUNC
* @tc.require:
*/
HWTEST_F(OptionsCmdTest, params_run_test_102, testing::ext::TestSize.Level1)
{
...
/*
* @tc.name: params_run_test_103
* @tc.desc: main function entry function.
* @tc.type: FUNC
* @tc.require:
*/
HWTEST_F(OptionsCmdTest, params_run_test_103, testing::ext::TestSize.Level1)
{
