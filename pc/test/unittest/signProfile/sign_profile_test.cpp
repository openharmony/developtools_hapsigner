...
static const std::string SIGN_APP_IN_FILE = "./signProfile/phone-default-unsigned.hap";
...
static const std::string SIGN_APP_OUT_FILE = "./signProfile/phone-default-signed.hap";


static const std::string VERIFY_APP_CERT_FILE = "./signProfile/certchain.pem";
static const std::string VERIFY_APP_PROFILE_FILE = "./signProfile/profile.p7b";
static const std::string VERIFY_APP_IN_FILE = "./signProfile/phone-default-signed.hap";
 ...
 */
    ...
    */
    HWTEST_F(SignProfileTest, run_verify_app_test001, testing::ext::TestSize.Level1)
    {
        ...
        LocalizationAdapter adapter(&options);
        SignToolServiceImpl api;
        bool result = ParamsRunTool::RunVerifyApp(&options, api);
        EXPECT_EQ(result, true);
    }
}
}