...
static const std::string SIGN_PROFILE_PROFILE_CERT_FILE = "/data/test/signProfile/profile-release1.pem";
static const std::string SIGN_PROFILE_SIGN_ALG = "SHA384withECDSA";
static const std::string SIGN_PROFILE_KEY_STORE_FILE = "/data/test/signProfile/ohtest.p12";
static const std::string SIGN_PROFILE_OUT_FILE = "/data/test/signProfile/signed-profile.p7b";
static const std::string SIGN_PROFILE_IN_FILE = "/data/test/signProfile/profile.json";
//verify profile 使用的全局参数
static const std::string VERIFY_PROFILE_IN_FILE = "/data/test/signProfile/signed-profile.p7b";
static const std::string VERIFY_PROFILE_OUT_FILE = "/data/test/signProfile/verify-result.json";
//sign app 使用全局参数
static const std::string SIGN_APP_MODE = "localSign";
static const std::string SIGN_APP_KEY_ALIAS = "oh-app1-key-v1";
static const std::string SIGN_APP_APP_CERT_FILE = "/data/test/signProfile/app-release1.pem";
static const std::string SIGN_APP_PROFILE_FILE = "/data/test/signProfile/signed-profile.p7b";
static const std::string SIGN_APP_IN_FILE = "/data/test/signProfile/phone-default-unsigned.hap";
static const std::string SIGN_APP_SIGN_ALG = "SHA256withECDSA";
static const std::string SIGN_APP_KEY_STORE_FILE = "/data/test/signProfile/ohtest.p12";
static const std::string SIGN_APP_OUT_FILE = "/data/test/signProfile/phone-default-signed.hap";


static const std::string VERIFY_APP_CERT_FILE = "/data/test/signProfile/certchain.pem";
static const std::string VERIFY_APP_PROFILE_FILE = "/data/test/signProfile/profile.p7b";
static const std::string VERIFY_APP_IN_FILE = "/data/test/signProfile/phone-default-signed.hap";
...
namespace OHOS::SignatureTools {
    ...
    HWTEST_F(SignProfileTest, run_sign_profile_test001, testing::ext::TestSize.Level1)
    {
        ...
        bool result = HapSignTool::RunSignProfile(&options, api);
 ...
 */
    HWTEST_F(SignProfileTest, run_verify_profile_test001, testing::ext::TestSize.Level1)
    {
        ...
        SignToolServiceImpl api;
        HapSignTool::RunVerifyProfile(&options, api);
    }
    ...
    */
    ...
    HWTEST_F(SignProfileTest, parse_test002, testing::ext::TestSize.Level1)
    {
        ...
        FileUtils::ReadFile(VERIFY_PROFILE_IN_FILE, p7b);
        PKCS7Data p7;
        std::vector<signed char> p7b_(p7b.begin(), p7b.end());
    ...
    HWTEST_F(SignProfileTest, generate_signeddata_test001, testing::ext::TestSize.Level1)
    {
        ...
        SignatureAlgorithmClass algClass;
        std::vector<SignatureAlgorithmClass> sigs;
        sigs.resize(1);
 ...
 */
    HWTEST_F(SignProfileTest, run_sign_app_test001, testing::ext::TestSize.Level1)
    {
        ...
        std::string appCertFile = "./signProfile/app-release1.pem";
        std::string profileFile = "./signProfile/signed-profile.p7b";
        std::string inFile = "./signProfile/phone-default-unsigned.hap";
        std::string keystoreFile = "./signProfile/ohtest.p12";
        std::string outFile = "./signProfile/phone-default-signed.hap";
        char keyPwd[] = "123456";
        char keystorePwd[] = "123456";
 ...
 */
    ...
    {
        Options options;
        std::string outFile = VERIFY_APP_CERT_FILE;
        std::string outprofile = VERIFY_APP_PROFILE_FILE;
        std::string inFile = VERIFY_APP_IN_FILE;
        options[Options::OUT_CERT_CHAIN] = outFile;
        options[Options::IN_FILE] = inFile;
        options[Options::OUT_PROFILE] = outprofile;
        LocalizationAdapter adapter(&options);
        SignToolServiceImpl api;
        bool result = HapSignTool::RunVerifyApp(&options, api);
        EXPECT_EQ(result, true);
    }
}