 ...
 * @tc.require: SR000H63TL
 */
HWTEST_F(CodeSigningTest, splitFileName001, testing::ext::TestSize.Level1)
{
    SignerConfig signerConfig;
    signerConfig.SetCompatibleVersion(9);
 ...
 * @tc.require: SR000H63TL
 */
HWTEST_F(CodeSigningTest, splitFileName002, testing::ext::TestSize.Level1)
{
    SignerConfig signerConfig;
    signerConfig.SetCompatibleVersion(9);
