...
void VerifyHapTest::SetUpTestCase(void)
{
    ...
    (void)rename("./hapVerify/packet_diget_algo_error.txt", "./hapVerify/test.hap");
    (void)rename("./hapVerify/packet_hap_integrity_error.txt", "./hapVerify/test1.hap");
    (void)rename("./hapVerify/packet_verify_app_error.txt", "./hapVerify/test2.hap");
    (void)rename("./hapVerify/packet_get_certchain_error.txt", "./hapVerify/test3.hap");
    (void)rename("./hapVerify/packet_get_optional_block_error.txt", "./hapVerify/test4.hap");
    (void)rename("./hapVerify/packet_parse_profile_error.txt", "./hapVerify/test5.hap");
