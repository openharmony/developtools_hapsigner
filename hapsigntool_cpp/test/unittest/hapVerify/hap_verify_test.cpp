...
void VerifyHapTest::SetUpTestCase(void)
{
    ...
    (void)rename("./hapVerify/test.txt", "./hapVerify/test.hap");
    (void)rename("./hapVerify/test1.txt", "./hapVerify/test1.hap");
    (void)rename("./hapVerify/test2.txt", "./hapVerify/test2.hap");
    (void)rename("./hapVerify/test3.txt", "./hapVerify/test3.hap");
    (void)rename("./hapVerify/test4.txt", "./hapVerify/test4.hap");
    (void)rename("./hapVerify/test5.txt", "./hapVerify/test5.hap");
}
