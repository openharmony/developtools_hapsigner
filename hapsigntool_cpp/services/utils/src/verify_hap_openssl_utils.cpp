...
int32_t VerifyHapOpensslUtils::GetDigestAlgorithmOutputSizeBytes(int32_t nId)
{
    return EVP_MD_size(EVP_get_digestbynid(nId));
}

bool VerifyHapOpensslUtils::CheckDigestParameter(const DigestParameter& digestParameter)
{
...
bool VerifyHapOpensslUtils::DigestInit(const DigestParameter& digestParameter)
{
...
bool VerifyHapOpensslUtils::DigestUpdate(const DigestParameter& digestParameter,
...
int32_t VerifyHapOpensslUtils::GetDigest(const DigestParameter& digestParameter,
...
int32_t VerifyHapOpensslUtils::GetDigest(const ByteBuffer& chunk,
...
int32_t VerifyHapOpensslUtils::GetDigestAlgorithmId(int32_t signAlgorithm)
{
