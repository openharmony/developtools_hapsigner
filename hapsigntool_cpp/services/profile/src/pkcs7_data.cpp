                                         ...
                                         STACK_OF(X509)* certs, STACK_OF(X509)* certChain)const
{
    ...
    if (VerifyCertOpensslUtils::CertVerify(sigCert, sk_X509_value(certs, 0)) == false) {
    ...
    if (VerifyCertOpensslUtils::CertVerify(sk_X509_value(certs, j), sk_X509_value(certs, j)) == false) {
